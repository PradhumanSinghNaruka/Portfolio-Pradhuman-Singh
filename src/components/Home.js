    ...
    <>
      ...
      >
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 mt-12 md:mt-44 space-y-4 order-2 md:order-1">
            <span className="text-4xl md:text-5xl font-bold">Welcome In My Feed</span>
            <div className="flex space-x-1 text-2xl md:text-4xl">
              <h1 className="text-2xl md:text-4xl font-semibold" >Hello I'm a </h1>
            ...
            <p className="text-xl md:text-2xl">
              Hello everyone,I'm engineering student.Goal-driven creative
              mindset with a passion for learning and innovating. I'm on a track
              for learning more about Web Development, Machine learning and Data
              Science.
            </p>
            <br />
            <div>
